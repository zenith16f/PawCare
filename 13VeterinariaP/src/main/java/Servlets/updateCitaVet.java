 ...
 * @author fer_1
 */
public class updateCitaVet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int temperatura = Integer.parseInt(request.getParameter("temp"));
        ...
        cita.setTemperatura(temperatura);
        ...
        try {
            ...
            response.sendRedirect("citasVet.jsp");
