...
public class eliminarCita extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            // Obtener el ID de la cita a eliminar desde los parámetros de la solicitud
            ...
            try {
                ...
                // Crear una instancia de CitaDAO y llamar al método eliminarCita
                ...
                response.sendRedirect("citasProp.jsp");
            } catch (SQLException e) {
                // En caso de error, redireccionar a una página de error o mostrar un mensaje
