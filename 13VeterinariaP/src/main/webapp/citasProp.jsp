<%--
    Document   : citasProp
    Created on : 4 jun 2023, 23:41:42
    Author     : Zenith
--%>
                ...
                <tbody>
                    <%
                        try {
                            ...
                            List<Cita> citas = citaDao.obtenerCitasPorMascota(id);
                    ...
                    <tr>
                        <th scope="row"><%=cita.getFechaCita()%></th>
                        <td><%=cita.getDescripcionTipo()%></td>
                        <td><%=cita.getNota()%></td>
                        <td><%=cita.getNombreVeterinario()%></td>
                        <td><a href="infoCita.jsp?id=<%=cita.getId()%>">Informacion de la cita</a> </td>
                        <td><a href="eliminarCita?id=<%=cita.getId()%>">Cancelar Cita</a> </td>
                    </tr>
