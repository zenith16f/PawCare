<%--
    Document   : inicio
    Created on : 11 may 2023, 20:05:36
    Author     : Zenith
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <h1>Bienvenido </h1>
        <h4>Como propietario de una mascota estas son tus opciones:</h4>
        <a href="registroMascota.jsp"> Registrar Mascota</a>
        <br>
        <a href="cita.jsp">Agendar cita</a>
        <br>
        <a href="propias.jsp">Mis mascotas</a>
        <br>
        <a href="veterinarios.jsp">Nuestro equipo de veterinarios</a>
        <footer>
            <div class="container">
