<%--
    Document   : vetLogin
    Created on : 30 may 2023, 14:12:32
    Author     : Zenith
--%>
    ...
    <body>
        ...
        <main>
            <div class="container form">
                ...
                <form action="LoginVet" method="post" id="form">
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <p class="text-center link">¿No estás registrado? <a href="./vetRegistro.html">Registrarme</a></p>
                        </div>
                        <div class="col-12 text-center buttons">
                            <input class="btn btn-outline-primary" type="submit" value="Ingresar" onclick="window.location.href = './vetindex.html'">
