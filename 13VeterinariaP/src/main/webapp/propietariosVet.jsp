<%--
    Document   : mascotasVet
    Created on : 2 jun 2023, 01:26:11
    Author     : Zenith
--%>

<%@page import="Model.Propietario"%>
<%@page import="DAO.PropietarioDAO"%>
...
<html lang="es">
    ...
    <body>
        ...
        <main>
            ...
            <h1 class="text-center">Propietario Registrados</h1>
            <div class="container">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row"><%=propietario.getId_propietario()%></th>
                            <td><%=propietario.getCorreo()%></td>
                            <td><%=propietario.getNombre()%></td>
                            <td><%=propietario.getAppat()%></td>
                            <td><%=propietario.getApmat()%></td>
                            <td><%=propietario.getDir()%></td>
                        </tr>
                        ...
                        <%
                                ...
                                System.out.println("Error al obtener a los propietarios");
