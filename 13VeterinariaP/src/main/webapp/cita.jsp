<%--
    Document   : cita
    Created on : 30 may 2023, 12:09:34
    Author     : Zenith
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <main>
            <h1 class="text-center">Agenda la cita de tu mascota</h1>
            <div class="container">

                <form action="crearCitaMascota" method="post" name="agendarCita">

                    <label>Tipo de cita</label>
                    <select name="id_tipo_cita">
                        ...
                        <%
                            ...
                            List<Cita> tipos = citaDao.getTipoCitas();

                            for (Cita cita : tipos) {
                        %>

                        <option value="<%=cita.getIdTipoCita()%>"><%=cita.getDescripcionTipo()%></option>
                    ...
                    <br>
                    <label>Nota extra sobre tu mascota (Opcional)</label>
                    ...
                    <select name="id_veterinario">
                        ...
                        <%
                            try {
                                ...
                                System.out.println("Veterinario Obtenidos");

                                for (Veterinario veterinario : veterinarios) {

                        %>

                        <option value="<%=veterinario.getCedula()%>">
                        ...
                        <%
                                ...
                                System.out.println("Error al obtener los veterinarios");
                                System.out.println("ERROR: " + ex.getMessage());
                            }
                        %>
                    </select>
