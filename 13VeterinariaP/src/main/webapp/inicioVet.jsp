<%--
    Document   : inicioVet
    Created on : 30 may 2023, 14:29:44
    Author     : Zenith
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <main>
            <h1>Bienvenido</h1>
            <h4>Como veterinario estas son tus opciones</h4>
            <a href="mascotasVet.jsp">Mascotas Registradas</a>
            <br>
            <a href="propietariosVet.jsp">Propietarios Registrados</a>
            <br>
            <a href="citasVet.jsp">Citas Agendadas</a>
